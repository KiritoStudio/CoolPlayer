...
#define CLC_RTPLAYER_LISTVIEW_WINDOWCLASSNAME "RTPlayer_ListView"
////////////////////////////////////////////////////////////////////////////////
//
//
//
CP_HLISTVIEW CLV_Create(HWND hWndParent, const int iX, const int iY, const int iWidth, const int iHeight)
{
	...
	wcPlaylist.lpszClassName = CLC_RTPLAYER_LISTVIEW_WINDOWCLASSNAME;
	...
	hWndWindow = CreateWindowEx(WS_EX_ACCEPTFILES,
								CLC_RTPLAYER_LISTVIEW_WINDOWCLASSNAME,
								"",
